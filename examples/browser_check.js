...
Opal.queue(function(Opal) {/* Generated by Opal 1.8.3 */
  var $klass = Opal.klass, $send = Opal.send, $return_val = Opal.return_val, $def = Opal.def, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$, document = nil, stack = nil, cells = nil, rect = nil, tops = nil, report = nil, pre = nil;

  Opal.add_stubs('require,stack,label,mount_at,new,Native,querySelector,querySelectorAll,getBoundingClientRect,to_n,[],length,!=,createElement,setAttribute,[]=,appendChild,body');
  
  self.$require("citrine/browser");
  self.$require("native");
  (function($base, $super) {
    var self = $klass($base, $super, 'BrowserProbe');

    
    return $def(self, '$view', function $$view() {
      var self = this;

      return $send(self, 'stack', [(new Map([["css_class", "stack"]]))], function $$1(){var self = $$1.$$s == null ? this : $$1.$$s;

        
        $send(self, 'label', [(new Map([["css_class", "cell"]]))], $return_val("A"));
        return $send(self, 'label', [(new Map([["css_class", "cell"]]))], $return_val("B"));}, {$$s: self})
    })
  })($nesting[0], $$$($$('Citrine'), 'Component'));
  $$$($$('Citrine'), 'DomRenderer').$mount_at("app", $$('BrowserProbe').$new());
  document = self.$Native(window.document);
  ...
  report = (new Map([["stack_width", rect['$[]']("width")], ["stack_height", rect['$[]']("height")], ["cell_count", tops.$length()], ["top_distinct", tops['$[]'](0)['$!='](tops['$[]'](1))]]));
